...
var router = exports.router = {
	 ...
	 */
	register: function (pattern, handler, methods) {
	    var route = new router.Route(pattern, handler, methods);
 ...
 * @constructor
 */
var Route = function (pattern, handler, methods, auth_redirect) {
 ...
 */
Route.prototype.evaluateParams: function (request) {
